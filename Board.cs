...
namespace TODO_uygulama
{
     public class Board
    {
        ...
        public Board()
        {
            KisiList.Add(0, "Yavuz Kocar");
            KisiList.Add(1, "Hakan Demir");
            KisiList.Add(2, "Oguzhan çiftçi");
            KisiList.Add(3, "Ali Erkam");
            KisiList.Add(4, "Ahmet Gültekin");

            TODO.Add(new Kart("Grafik tasarım", "Logo tasarla", "Yavuz Kocar", Kart.Buyuluk.M));
            TODO.Add(new Kart("3d çizim", "Karakter modelle", "Hakan Demir", Kart.Buyuluk.XL));
            TODO.Add(new Kart("Yazılım", "Gerekli düzenlemeler tamamlanacak", "Oguzhan çiftçi", Kart.Buyuluk.L));
            TODO.Add(new Kart("muhasebe", "Maaşları yatır", "Ahmet Gültekin", Kart.Buyuluk.S));
            TODO.Add(new Kart("Alışveriş", "gıda al", "Ali Erkam", Kart.Buyuluk.XS));
        }
